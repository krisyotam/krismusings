...
tags:
  - javascript
  - serverless
devto: https://dev.to/krisyotam/using-faunadb-and-netlify-functions-for-analytics-361m
---
...
You can use Netlify Functions to talk to a database such as FaunaDB. In the below example, we use tracking page hits as a use-case to save into the database. You can found the source code to the Netlify Function [here](https://github.com/krisyotam/krisyotam.com/blob/master/functions/tracker.js).
