...
tags:
  - javascript
  - tailwindcss
devto: https://dev.to/krisyotam/adding-dark-mode-to-your-tailwind-css-website-47m7
---

Tailwind CSS v2.0 introduces [Dark mode support](https://tailwindcss.com/docs/dark-mode) and with minimal JS and inline SVG, you can allow your users to manually toggle Dark Mode. We are going to walk through what is required to build the same one from [krisyotam.com](https://krisyotam.com).
...
You can view the [source code](https://github.com/krisyotam/krisyotam.com/blob/master/src/_includes/base.njk) to see it all put together.
...
You will then need to extend the rest of your styles. [Use this blog's config as an example](https://github.com/krisyotam/krisyotam.com/blob/master/tailwind.config.js).
