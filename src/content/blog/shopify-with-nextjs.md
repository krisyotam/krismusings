...
tags:
  - performance
devto: https://dev.to/krisyotam/improving-shopify-page-performance-using-next-js-1ihb
---
...
At the time of migrating to the new website, the Next.js Commerce framework was relatively new and so a [Shopify Provider](https://github.com/krisyotam/nextjs-commerce-shopify) was required for the integration with the Shopify APIs.
