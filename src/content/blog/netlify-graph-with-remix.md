...
tags:
  ...
  - netlify
  - remix
devto: https://dev.to/krisyotam/how-to-build-an-app-with-remix-and-netlify-graph-554k
---
...
The source code for this app can be found [in this repository](https://github.com/krisyotam/netlify-graph-remix). Add an issue to the repository (or add a comment to an existing issue) to see the changes get reflected instantly on the [demo app](https://netlify-graph-remix.netlify.app/).
...
export const loader = async () => {
  const { data } = await NetlifyGraph.fetchIssues(
    { owner: 'krisyotam', name: 'netlify-graph-remix' },
